...
// prend un SNP et update toute la matrice
template <typename scalar_t>
void RawKinMatrix<scalar_t>::updateAdd(const std::vector<scalar_t> & P1, const std::vector<scalar_t> & P2, scalar_t q) {
...
// idem pour le calcul de la matrice de dominance
template <typename scalar_t>
void RawKinMatrix<scalar_t>::updateDom(const std::vector<scalar_t> & P1, const std::vector<scalar_t> & P2, scalar_t q) {
